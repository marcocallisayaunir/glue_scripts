...
Filter_node1712150539542 = Filter.apply(frame=SelectFields_node1712150528515, f=lambda row: (bool(re.match("teacher", row["shortname"]))), transformation_ctx="Filter_node1712150539542")

# Script generated for node Filter
Filter_node1712156790585 = Filter.apply(frame=SelectFields_node1712151798083, f=lambda row: (bool(re.match("TeacherEnrollment", row["name"]))), transformation_ctx="Filter_node1712156790585")

# Script generated for node SQL Query
SqlQuery0 = '''
select * from myDataSource
where sis_user_id != '' and workflow_state = 'active'
'''
...
ChangeSchema_node1712151004616 = ApplyMapping.apply(frame=Join_node1712150935850, mappings=[("internal_user_id", "long", "internal_user_id", "long"), ("idnumber", "string", "id_integration_teacher", "string"), ("fullname", "string", "fullname", "string")], transformation_ctx="ChangeSchema_node1712151004616")
...
# Script generated for node Change Schema
ChangeSchema_node1712157174274 = ApplyMapping.apply(frame=Join_node1712157156158, mappings=[("user_id", "long", "internal_user_id", "long"), ("sis_user_id", "string", "id_integration_teacher", "string"), ("name", "string", "fullname", "string")], transformation_ctx="ChangeSchema_node1712157174274")
...
AmazonRedshift_node1712151213278 = glueContext.write_dynamic_frame.from_options(frame=drop_duplicates_node, connection_type="redshift", connection_options={"redshiftTmpDir": "s3://aws-glue-assets-760557048868-eu-west-1/temporary/", "useConnectionProperties": "true", "dbtable": "public.staff", "connectionName": "Redshift Cluster Apify", "preactions": "DROP TABLE IF EXISTS public.staff; CREATE TABLE IF NOT EXISTS public.staff (id BIGINT IDENTITY(1,1) PRIMARY KEY, fullname VARCHAR, id_integration_teacher VARCHAR, internal_user_id BIGINT);"}, transformation_ctx="AmazonRedshift_node1712151213278")
